...
const config: HardhatUserConfig = {
  ...
  networks: {
    polygon: {
      url:
        process.env.POLYGON_ALCHEMY_KEY || 'https://polygon-mumbai.g.alchemy.com/v2/123abc123abc123abc123abc123abcde',
      accounts: process.env.MAIN_PRIVATE_KEY ? [process.env.MAIN_PRIVATE_KEY] : [],
      gasPrice: 110000000000,
    },
    mumbai: {
      url: process.env.MUMBAI_ALCHEMY_KEY || 'https://polygon.g.alchemy.com/v2/123abc123abc123abc123abc123abcde',
      accounts: process.env.TEST_PRIVATE_KEY ? [process.env.TEST_PRIVATE_KEY] : [],
    },
    goerli: {
      url: process.env.GOERLI_ALCHEMY_KEY || 'https://polygon-mumbai.g.alchemy.com/v2/123abc123abc123abc123abc123abcde',
      accounts: process.env.TEST_PRIVATE_KEY ? [process.env.TEST_PRIVATE_KEY] : [],
    },
    local: {
